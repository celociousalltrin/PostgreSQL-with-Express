...
import { responseDetailsTypes, tokenGenertionDataTypes } from "./utils-types";
...
//Class based Cusom Error For Service Layer to mainatain SST(Single SSource of Truth) for
